...
"""Compile and run the C++ segfont contact-sheet generator."""
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        "--output",
        type=Path,
        default=segfont_dir / "segfont_contact_sheet.svg",
    ...
    source = here / "segfont_contact_sheet.cpp.in"
    build_dir = here / ".build"
    binary = build_dir / "segfont_contact_sheet"
